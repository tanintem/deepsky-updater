...
if __name__ == '__main__':
    ...
    # for path in labels_train[0:5]:
    #     print(path)


#helper function for read image
...
def get_data_dir(dir='input'):
    dataset = DataSet(dir,'label')
    return dataset.get_training_set()

dataset = DataSet('inpiut','label')
dataset2 = DataSet('traindata','label')
dataset3 = DataSet('daydata','label')
image_paths_train = dataset.get_training_set()
image_daily = dataset3.get_training_set()